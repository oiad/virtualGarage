...
if ((_queryResult select 0) == 0) exitWith {diag_log format ["extDB: Error: %1 - Unable to connect to the database. Check User/pass/IP settings.", _queryResult]; []};
...
if (!_multiarr) then {_return = _return select 0;};
