...
3. Copy the dayz_code and scripts folder to your mission folder preserving the directory structure.

4. Replace your original description.ext with the one provided or merge the contents if you have modified your own version.
